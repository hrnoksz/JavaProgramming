...
public class Item {
    ...
    inheritance constructors and calling parent class constructor
    overriding list with custom classes
     ...
     */
    public Item(String name, int quantity, double price, int catalogNumber){
        this.name = name;
