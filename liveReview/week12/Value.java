...
public class Value {
     ...
     */
    int param = 0; // you can omit initializing to zero
    boolean calledMethod = false;
    boolean calledConstructor = false;

    public Value(){ //no parameters constructor
    }
    ...
    public int getValue(){
        /*
        below code becomes redundant because it is going to return instance variable in
        all conditions
