...
public class Person {
    ...
    public Person(){ //Overloading constructor without parameter
        firstName = "undefined"; // we don't need to use "this" keyword here.
        lastName = "undefined";
        age = -1;
    }

    public Person(String firstName, String lastName, int age) { //Overloading constructor with parameter
        this.firstName = firstName;
        this.lastName = lastName;
        this.age = age;
    }
