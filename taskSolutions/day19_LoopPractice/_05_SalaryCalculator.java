...
public class _05_SalaryCalculator {
...
5. Write a program for the salary calculator
			...
			2. Ask the user  "How many hours do you work per week?"
					if user entered weeklyHour is less than 1 or greater than 144, terminate the program after
					displaying the error message "Invalid Entry for Weekly Hours"
