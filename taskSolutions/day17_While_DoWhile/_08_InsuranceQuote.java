...
public class _08_InsuranceQuote {
    ...
    public static void main(String[] args) {
        ...
        String hadAccidentsOrClaim = scan.next().toLowerCase();
        while (!(hadAccidentsOrClaim.equals("yes") || hadAccidentsOrClaim.equals("no"))){
            hadAccidentsOrClaim = scan.next().toLowerCase();
        }
        System.out.println("Does your car have anti-theft device?");
        ...
        System.out.println("Had accidents or claim = " + hadAccidentsOrClaim);
