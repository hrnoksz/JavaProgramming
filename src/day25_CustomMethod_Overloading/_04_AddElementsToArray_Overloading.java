...
public class _04_AddElementsToArray_Overloading {
    ...
    public static void main(String[] args) {
        ...
        String[] names = {"Ahmet", "Sinem", "Cihad"}; // "Layan"
        ...
        System.out.println("names = " + Arrays.toString(names)); // names = [Ahmet, Sinem, Cihad, Layan]
