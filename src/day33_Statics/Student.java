...
1. Create a class called Student:
				...
				Add a constructor that allows user to create object by setting the name, studentID
				...
				Add a constructor that allows user to create object by setting the name, gender, age,
