...
public class _02_ArrayPractice_01 {
    ...
    public static void main(String[] args) {
        ...
        int[] scores = new int[5]; // If we don't assign the value to data, then result is [0, 0, 0, 0, 0]

        scores[1] = 85;
        scores[scores.length-1] = 95; //5-1 = 4 ===> last index = scores.length-1
        scores[3] = 75;
        scores[0] = 65;
        scores[2] = 55;

        System.out.println(Arrays.toString(scores)); //[65, 85, 55, 75, 95] ==> prints according to index order
                                                     //  0   1   1   3   4
